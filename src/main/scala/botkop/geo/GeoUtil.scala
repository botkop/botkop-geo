...
object GeoUtil {
  ...
  /**
    ...
    */
  def containsLocation(point: LatLng,
                       polygon: List[LatLng],
                       geodesic: Boolean = true): Boolean = {
  ...
  /**
    ...
    */
  def intersects(lat1: Double,
                 lat2: Double,
                 lng2: Double,
                 lat3: Double,
                 lng3: Double,
                 geodesic: Boolean): Boolean = {
  ...
  /**
    ...
    */
  def tanLatGC(lat1: Double, lat2: Double, lng2: Double, lng3: Double): Double =
  ...
  /**
    ...
    */
  def mercatorLatRhumb(lat1: Double,
                       lat2: Double,
                       lng2: Double,
                       lng3: Double): Double =
  ...
  /**
    ...
    */
  def mercator(lat: Double): Double =
    log(tan(lat * 0.5 + PI / 4))

  /**
    * Returns lat from mercator Y.
    */
  def inverseMercator(y: Double): Double =
    2 * atan(exp(y)) - PI / 2

  /**
    * Wraps the given value into the inclusive-exclusive interval between min and max.
    */
  def wrap(n: Double, min: Double, max: Double): Double =
